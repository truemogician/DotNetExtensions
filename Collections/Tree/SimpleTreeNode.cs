...
public abstract class SimpleTreeNode<T>(T? parent) : ITree<T>, IEnumerable<T>
	where T : SimpleTreeNode<T> {
	// ReSharper disable once InconsistentNaming
	protected internal readonly IList<T> _children = new List<T>();

	private T? _parent = parent;
	...
	public IEnumerable<T> Descendants => Children.SelectMany(n => n);
...
/// </summary>
public sealed class ValuedSimpleTreeNode<T>(T value, ValuedSimpleTreeNode<T>? parent = null)
	: SimpleTreeNode<ValuedSimpleTreeNode<T>>(parent) {
