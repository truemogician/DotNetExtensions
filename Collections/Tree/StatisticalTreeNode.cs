...
public abstract class StatisticalTreeNode<T> : TreeNode<T> where T : StatisticalTreeNode<T> {
	...
	/// </summary>
	/// <returns><see langword="null"/>> if <paramref name="node1" /> and <paramref name="node2" /> are not in the same tree</returns>
...
///     instead.
/// </summary>
public sealed class ValuedStatisticalTreeNode<T>(T value, ValuedStatisticalTreeNode<T>? parent = null) : StatisticalTreeNode<ValuedStatisticalTreeNode<T>>(parent) {
