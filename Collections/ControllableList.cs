...
public class ControllableList<T> : IExtendedList<T> {
	...
	/// <summary>
	///     Set <see langword="false"/> to disable <see cref="ListChanging" /> event and save relevant space and time cost
	/// </summary>
	public bool ChangingEventEnabled { get; set; } = true;

	/// <summary>
	///     Set <see langword="false"/> to disable <see cref="ListChanged" /> event and save relevant space and time cost
	/// </summary>
...
public abstract class ControllableListAddedRemovedEventArgs<T>(T value, int index) : ControllableListChangedEventArgs {
	public T Value { get; } = value;

	public int Index { get; } = index;
}

public abstract class ControllableListRangeChangedEventArgs<T>(IReadOnlyList<T> values) : ControllableListChangedEventArgs {
	public IReadOnlyList<T> Values { get; } = values;

	public int Count => Values.Count;
}

public class ControllableListAddedEventArgs<T>(T value, int index) : ControllableListAddedRemovedEventArgs<T>(value, index) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.Add;
}

public class ControllableListRangeAddedEventArgs<T>(IReadOnlyList<T> values, int index) : ControllableListRangeChangedEventArgs<T>(values) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.AddRange;

	public int Index { get; } = index;
}

public class ControllableListRemovedEventArgs<T>(T value, int index) : ControllableListAddedRemovedEventArgs<T>(value, index) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.Remove;
}

public class ControllableListRangeRemovedEventArgs<T>(IReadOnlyList<T> values, int index) : ControllableListRangeChangedEventArgs<T>(values) {
...
public class ControllableListReplacedEventArgs<T>(T oldValue, T newValue, int index) : ControllableListChangedEventArgs {
...
public class ControllableListReorderedEventArgs<T>(IReadOnlyList<T> values, int index) : ControllableListRangeChangedEventArgs<T>(values) {
...
public abstract class ControllableListAddingRemovingEventArgs<T>(T value, int index) : ControllableListChangingEventArgs {
	public T Value { get; } = value;

	public int Index { get; } = index;
}

public abstract class ControllableListChangingRangeEventArgs<T>(IReadOnlyList<T> values) : ControllableListChangingEventArgs {
	public IReadOnlyList<T> Values { get; } = values;

	public int Count => Values.Count;
}

public class ControllableListAddingEventArgs<T>(T value, int index) : ControllableListAddingRemovingEventArgs<T>(value, index) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.Add;
}

public class ControllableListAddingRangeEventArgs<T>(IReadOnlyList<T> values, int index) : ControllableListChangingRangeEventArgs<T>(values) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.AddRange;

	public int Index { get; } = index;
}

public class ControllableListRemovingEventArgs<T>(T value, int index) : ControllableListAddingRemovingEventArgs<T>(value, index) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.Remove;
}

public class ControllableListRemovingRangeEventArgs<T>(IReadOnlyList<T> values, int index) : ControllableListChangingRangeEventArgs<T>(values) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.RemoveRange;
...
public class ControllableListReplacingEventArgs<T>(T oldValue, T newValue, int index) : ControllableListChangingEventArgs {
	public override ControllableListChangeAction Action => ControllableListChangeAction.Replace;
...
public class ControllableListReorderingEventArgs<T>(IReadOnlyList<T> values, int index) : ControllableListChangingRangeEventArgs<T>(values) {
	public override ControllableListChangeAction Action => ControllableListChangeAction.Reorder;
